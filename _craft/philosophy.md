...
<div class="container">
    ...
    background_size="50%"
    background_position="right"
    content=" <!-- TODO: review and refine and add links -->
    <details class='accordion'>
        ...
        <div class='accordion__content'>
            ...
            <p>These traditions, each in their way, remind us that wisdom isn't something to grasp but a way of being to cultivate. The path itself becomes the destination—a constant unfolding rather than a final arrival.</p>
        </div>
    </details>
    <details class='accordion'>
