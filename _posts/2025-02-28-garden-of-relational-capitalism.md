...
A brief on my choice to use “First Peoples” over “Indigenous”... words in this context I’m led to believe show how language perpetuates systemic injustice. Terms like "Indigenous" (Latin indigen “wanting”, in and genus "not of the same kind") or "Native Title" (conditional, subordinate to Crown sovereignty) appear neutral but embed power claims. Their roots and legal frameworks seek to delegitimise sovereignty, framing the original inhabitants as passive recipients of rights that need to be conveyed by a higher authority. Real justice requires rejecting these terms and centering sovereign recognition which honours inherent land stewardship and authority. Language here is not just communication—it’s a tool to uphold oppression. The opposite is true too - a tool to dismantle that oppression.
...
<table>
  <thead>
    <tr>
      ...
      <th>Deeper Meaning (Roots/Colonial Reality)</th>
      <th>Sovereign-Based Recognition</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td><strong>Indigenous</strong></td>
      <td>Native to a land/region.</td>
      <td>Latin <em>indigen</em> ("wanting / in need of assistance"); erases sovereignty. Shared root with <em>indigent</em> ("destitute").</td>
      <td><strong>Original Peoples / First Peoples</strong></td>
    </tr>
    <tr>
      <td><strong>Aboriginal</strong></td>
      <td>Original inhabitants.</td>
      <td>Latin <em>ab-original</em> ("away from the origin"); frames sovereignty as historical, not living.</td>
      <td><strong>Original Inhabitants</strong></td>
    </tr>
    <tr>
      <td><strong>Traditional Owner</strong></td>
      <td>Respectful term for land stewards.</td>
      <td>Latin <em>traditio</em> ("transfer of ownership"); implies land was ceded to colonisers. Legitimises Crown authority.</td>
      <td><strong>True Owner / Sovereign</strong></td>
    </tr>
    <tr>
      <td><strong>Native Title</strong></td>
      <td>Legal recognition of Indigenous land rights.</td>
      <td>Conditional, subordinate to Crown sovereignty. Can be extinguished; With the overturning of "terra nullius" (land of no one), Allodial Title should be recognised (from Latin allodium "free people's land")</td>
      <td><strong>Allodial Title</strong></td>
    </tr>
  </tbody>
</table>
</div>
...
.language-table td {
  padding: 1rem;
  border-bottom: 1px solid rgba(214, 138, 89, 0.2);
  vertical-align: top;
}

.language-table tr:nth-child(even) {
  background: rgba(214, 138, 89, 0.05);
}
...
.language-table tr:hover {
  background: rgba(214, 138, 89, 0.1);
}
