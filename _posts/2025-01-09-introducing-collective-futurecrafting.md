...
<details class='accordion'>
        <summary class='accordion__trigger'>Daily/Personal:</summary>
        <div class='accordion__content'>
          <ul>
            ...
            <li>Give gratitude to one living being (E.g., river, plant, animal, person) each day in a tangible way</li>
...
<details class='accordion'>
        <summary class='accordion__trigger'>Relational:</summary>
        <div class='accordion__content'>
          <ul>
            <li>Share a story about hope or possibility with someone each week</li>
            <li>Ask a neighbour about their dreams for the community</li>
            <li>Invite someone new for a 'walking yarn'</li>
            <li>Start a tiny free library or community garden plot</li>
            <li>Host an informal 'tea and dreams' gathering</li>
          </ul>
        </div>
</details>
<details class='accordion'>
        <summary class='accordion__trigger'>Ecological:</summary>
        <div class='accordion__content'>
          <ul>
            <li>Tend to one plant and track its changes over time</li>
            <li>Learn the names of local birds, plants or trees in your area</li>
            <li>Document seasonal changes in your immediate environment</li>
            <li>Create small rituals around natural cycles (moon phases, seasons)</li>
          </ul>
        </div>
</details>
<details class='accordion'>
...
I call it Collective Futurecrafting because it's not about predicting or controlling the future, but about participating skilfully in its emergence. Like a garden, it requires both intention and surrender, both careful tending and trust in life's inherent creativity.
